...
class PlaybuzzAdmin {
	...
	public function admin_scripts() {
		...
		// Set translation strings for JS files
		...
		// Styles
		wp_register_style( 'playbuzz-admin',     plugins_url( 'css/admin.css',     __FILE__ ), false, '0.8.0' );
		wp_register_style( 'playbuzz-admin-rtl', plugins_url( 'css/admin-rtl.css', __FILE__ ), false, '0.8.0' );
		wp_enqueue_style(  'playbuzz-admin' );
		if ( is_rtl() )
			wp_enqueue_style(  'playbuzz-admin-rtl' );

		// Scripts
		wp_register_script( 'playbuzz-admin', plugins_url( 'js/playbuzz-admin.js', __FILE__ ), array( 'jquery' ), '0.8.0' );
