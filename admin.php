	...
	public function playbuzz_settings_page() {
		...
		<div class="wrap" id="playbuzz-admin">
			...
			<h2 class="nav-tab-wrapper">
				<a href="?page=<?php echo urlencode( $this->get_option_name() ); ?>&tab=start"      class="nav-tab <?php echo $active_tab == 'start'      ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Getting Started', 'playbuzz' ); ?></a>
				<a href="?page=<?php echo urlencode( $this->get_option_name() ); ?>&tab=embed"      class="nav-tab <?php echo $active_tab == 'embed'      ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Site Settings',   'playbuzz' ); ?></a>
				<a href="?page=<?php echo urlencode( $this->get_option_name() ); ?>&tab=shortcodes" class="nav-tab <?php echo $active_tab == 'shortcodes' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Shortcodes',      'playbuzz' ); ?></a>
				<a href="?page=<?php echo urlencode( $this->get_option_name() ); ?>&tab=feedback"   class="nav-tab <?php echo $active_tab == 'feedback'   ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Feedback',        'playbuzz' ); ?></a>
			</h2>
			...
			<?php if( $active_tab == 'start' ) { ?>
				...
				<div class="playbuzz_start">
					...
					<ol class="circles-list">
						<li>
							<p><?php esc_html_e( 'Create a new post / page', 'playbuzz' ); ?></p>
						</li>
						<li>
							<p><?php esc_html_e( 'Search for an item, or select one of our featured items', 'playbuzz' ); ?></p>
						</li>
						<li>
							<p><?php esc_html_e( 'Search for an item you want or select one of our featured items', 'playbuzz' ); ?></p>
						</li>
						<li>
				...
				<div class="playbuzz_start">
					...
					<ol class="circles-list">
						<li>
							<p><?php printf( __( 'You don’t have to manually set the options for each of your embeds! You can now use the <a href="%s">default site settings</a> panel', 'playbuzz' ), ('?page='.$this->get_option_name().'&tab=embed') ); ?></p>
						</li>
						<li>
							<p><?php printf( __( 'This panel  is always available for you <a href="%s">here</a> and at the following path: Settings > Playbuzz > Customization', 'playbuzz' ), ('?page='.$this->get_option_name().'&tab=embed') ); ?></p>
						</li>
						<li>
			...
			<?php } elseif( $active_tab == 'feedback' ) { ?>
				...
				<div class="playbuzz_feedback">
					...
					<p><?php esc_html_e( 'Want to learn how Playbuzz can take your publication’s engagement to new heights?', 'playbuzz' ); ?></p>
					<p><a href="https://publishers.playbuzz.com/" target="_blank"><?php esc_html_e( 'Lets Talk!', 'playbuzz' ); ?></a></p>
